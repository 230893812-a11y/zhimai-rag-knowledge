...
<div class="zhimai-graph-launch">
  <p>正在准备全库知识网络……</p>
  <p><button type="button" class="zhimai-open-graph global-graph-icon" aria-label="打开全屏知识图谱" onclick="document.querySelector('.graph-outer > .global-graph-icon')?.click()">打开全屏图谱 →</button></p>
